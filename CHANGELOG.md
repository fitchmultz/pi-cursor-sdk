...
- Record each distinct successfully used local Cursor agent once per native pi session in a non-resumable `cursor-sdk-agent-lineage` custom entry, including when local resume is disabled.
