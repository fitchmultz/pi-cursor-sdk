...
- `pi --version` reports Pi 0.87.0 for this cutover baseline.
- `npm ls` shows `@cursor/sdk@1.0.27` and local `@earendil-works/*@0.87.0` packages.
...
- The run uses Pi 0.87.0 `--session-id` successfully.
