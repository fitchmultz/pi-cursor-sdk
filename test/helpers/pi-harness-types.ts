...
// Replay fixtures store tool results in Pi's JSON transcript, not arbitrary host objects.
export type RegisteredTool = ToolDefinition<TSchema, JsonValue | undefined, unknown>;
